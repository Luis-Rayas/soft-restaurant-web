...
Route::post('/ingredientes/update/{id}', [IngredienteController::class, 'update'])->name('ingredienteUpdate');
Route::delete('/ingredientes/delete/{id}', [IngredienteController::class, 'delete'])->name('ingredienteDelete');
